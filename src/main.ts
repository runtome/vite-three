...
renderer.domElement.addEventListener('dblclick', (e) => {
  ...
  if (intersects.length) {
    ...
    //change the controls.target immediately, so that the camera will start to rotate around the new target point right away. The animation below is just for demonstration purpose, you can remove it if you don't need it.
